...
describe('filter', () => {
  ...
  describe('logical operators', () => {
    ...
    it('should handle implied logical operator on a single property', () => {
      ...
      const expected =
        "?$filter=DateProp ge datetime'2017-01-01T00:00:00.000Z' and DateProp le datetime'2017-03-01T00:00:00.000Z'";
      const actual = buildQuery({ filter });
      expect(actual).toEqual(expected);
    });
  ...
  describe('data types', () => {
    ...
    it('should handle a Date', () => {
      ...
      const expected = "?$filter=DateProp eq datetime'2017-03-30T07:30:00.000Z'";
      const actual = buildQuery({ filter });
      expect(actual).toEqual(expected);
    });
